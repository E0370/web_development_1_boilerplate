        ...
        <div class="col-12 col-sm-10 col-md-8 col-lg-6">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= $formAction ?? '/createaccount' ?>" class="needs-validation" novalidate autocomplete="off">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <span id="confirmpassword-feedback" class="text-danger small"></span>
                        </div>
